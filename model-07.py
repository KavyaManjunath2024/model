...
# Read, modify curing days to 7, and concatenate each CSV file into one DataFrame
for file in file_paths:
    data = pd.read_csv(file)
    data['curing_days'] = 7  # Set curing days to 7 for each sample
...
adjustment_factor = 0.90  # Use a different reduction factor to simulate the effect of 7-day curing
