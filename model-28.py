...
# Read, modify curing days to 28, and concatenate each CSV file into one DataFrame
for file in file_paths:
    data = pd.read_csv(file)
    data['curing_days'] = 28  # Set curing days to 28 for each sample
...
adjustment_factor = 0.80  # Use a different reduction factor to simulate the effect of 28-day curing
