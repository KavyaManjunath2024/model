...
# Read, modify curing days to 3, and concatenate each CSV file into one DataFrame
for file in file_paths:
    data = pd.read_csv(file)
    data['curing_days'] = 3  # Set curing days to 3 for each sample
...
adjustment_factor = 0.95  # Use a reduction factor to simulate the effect of 3-day curing
